...
# from utils_3dscene.p3drender import perform_camera_movement_with_cam_input, load_rail
# from utils_3dscene.nvrender import perform_camera_movement_with_cam_input, load_rail
from utils_3dscene.render_geak import perform_camera_movement_with_cam_input, load_rail
...
def main(args):
    ...
    if not use_5b_model:
        ...
        pipe = WanVideoPipelineNew.from_pretrained(
            ...
            device="cuda",
            model_configs=[
                ModelConfig(local_model_path="./checkpoints", model_id="Wan-AI/Wan2.2-TI2V-5B", origin_file_pattern="models_t5_umt5-xxl-enc-bf16.pth", offload_device="cpu", skip_download=True),
                ModelConfig(local_model_path="./checkpoints", model_id="Wan-AI/Wan2.2-TI2V-5B", origin_file_pattern="diffusion_pytorch_model*.safetensors", offload_device="cpu", skip_download=True),
                ModelConfig(local_model_path="./checkpoints", model_id="Wan-AI/Wan2.2-TI2V-5B", origin_file_pattern="Wan2.2_VAE.pth", offload_device="cpu", skip_download=True),
            ],
