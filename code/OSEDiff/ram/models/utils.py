...
def load_checkpoint_swinlarge(model, url_or_filename, kwargs):
    ...
    if is_url(url_or_filename):
        ...
        # Use preprocessed safetensors file if available (much faster to load)
        safetensors_path = os.path.splitext(url_or_filename)[0] + '_model_only.safetensors'
        if os.path.isfile(safetensors_path):
            from safetensors.torch import load_file
            print(f'Loading preprocessed safetensors: {safetensors_path}')
