...
import utils3d
from utils_3dscene.helper_funcs import merge_panorama_depth_fft
...
def main(
    ...
    for image_path in (pbar := tqdm(image_paths, desc='Total images', disable=len(image_paths) <= 1)):
        ...
        panorama_depth, panorama_mask = merge_panorama_depth_fft(merging_width, merging_height, splitted_distance_maps, splitted_masks, splitted_extrinsics, splitted_intriniscs)
